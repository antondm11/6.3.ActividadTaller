...
# Otros apuntes:
La clase Factura del proyecto es la que, al introducirla como nueva clase en el código, gracias a Mermaid se genera y se incorpora al diagrama UML, quedando éste ya modificado y actualizado con la nueva clase en el archivo DESIGN.md
